...
B05-P26 a két termék-domain gap klasszifikációját lezárja: mind a Mitsubishi cold/high-supply, mind a Dimplex A-10 pontok támogatott működési tartományon belül vannak. Az új residualok már nem domain-kérdések, hanem tiszta adat-hiányok: `MITSUBISHI_COLD_HIGH_SUPPLY_MINIMUM_POINT_EVIDENCE_REQUIRED` és `DIMPLEX_A_MINUS10_MINIMUM_POINT_EVIDENCE_REQUIRED`. Q-B05-004: `OPEN_NARROWED_TO_MINIMUM_POINT_GAPS_FANCOIL_AND_PRODUCT_TAU_EQ`. Readiness marad 45%.
...
- `docs/source_packs/B05_P26_PRODUCT_DOMAIN_CLASSIFICATION.md`
- `registry/b05_p26_product_domain_classification.csv`
