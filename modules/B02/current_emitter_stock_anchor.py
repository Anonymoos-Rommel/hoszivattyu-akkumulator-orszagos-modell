...
beneficiary publishes an exact dwelling denominator, exact installed cost-
allocator count and an additional explicit bathroom-radiator-place count.
...
def assess_current_emitter_stock_anchor(
    ...
    if qualified:
        ...
        if not math.isfinite(emitter_positions_per_dwelling):
            raise ValueError("NONFINITE_EMITTER_RATIO")
