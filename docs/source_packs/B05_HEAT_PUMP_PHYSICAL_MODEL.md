...
- **Synthetic grid (`SCN`)**: a hatpontos air-to-water rács csak motor- és tesztfixture; nem termék- vagy országos bizonyíték.
...
1. Nincs modellazonosított, forrásnatív operating-point performance map `OBS`-ként.
2. Nincs reprodukálható magyar 1-in-10/extreme weather sorozat.
3. Defrost-adat és külön modell hiányában nincs büntetés.
4. Minimum modulation, part-load COP és cycling degradation adata hiányzik; a motor csak állapotot jelez.
