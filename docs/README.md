...
- [B02-P3: Eligibility Layer Harmonization](source_packs/B02_P3_ELIGIBILITY_LAYER_HARMONIZATION.md) — machine-readable szeparáció a physical, technical, S2, legal, economic és final programme eligibility rétegek között; a legacy umbrella változó nem claim-specific authority.
- [B02-P4: Technical Component Authority Handoff](source_packs/B02_P4_COMPONENT_AUTHORITY_HANDOFF.md) — fail-closed producer-authority contract a thermal/hydraulic/electrical/permit komponensekre; cross-module authority önmagában nem eligibility evidence.
